...
internal fun StatusMessage.localized(): String {
    ...
    return when (this) {
        ...
        is StatusMessage.DisconnectedFrom -> stringResource(strings.status_disconnected_from, name)
        is StatusMessage.ReconnectingTo -> stringResource(strings.status_reconnecting_to, name)
        ...
        is StatusMessage.WatchEnabled -> stringResource(strings.status_watch_enabled, path.value)
        StatusMessage.WatchDisabled -> stringResource(strings.status_watch_disabled)
